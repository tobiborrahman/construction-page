        ...
        <>
            <div className="custom-container block sm:hidden">
                <div className="flex justify-between items-center">
                    <div className="py-[3px] w-[60px] h-[55px]">
                        <Image
                            src="/assets/Logo.svg"
                            width={60}
                            height={10}
            ...
            <div className="hidden sm:block">
                <div className="custom-container relative">
                    <div className="flex justify-between items-center py-3">
                        <div className="py-[3px] z-20">
                            <Image src="/assets/Logo.svg" width={60} height={80} alt="logo" />
                        </div>
                        <div>
                            {/* Hamburger Menu Button */}
                            <button
                                className={` ${menuOpen ? 'hidden' : 'block'} text-[24px] focus:outline-none`}
                                onClick={toggleMenu}
                            >
                                &#9776; {/* Hamburger Icon */}
                            </button>
                    ...
                    <nav
                        className={`${menuOpen ? 'flex animate-slideIn' : 'hidden animate-slideOut'} fixed top-0 left-0 w-full h-screen bg-white z-10`}
                    >
                        ...
                        <div className="absolute top-4 right-4">
                            {/* Close Menu Button */}
                            <button className="text-[24px] focus:outline-none" onClick={toggleMenu}>
                                &times; {/* Close Icon */}
                            </button>
                        </div>
                    </nav>
