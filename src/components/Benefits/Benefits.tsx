            ...
            <div className="custom-container">
                <div className="text-center mb-12">
                    ...
                    <p className="text-[12px] py-[20px]">
                        "Benefit from our efficient hiring process, matching
                        qualified candidates to your construction <br />
                        projects, ensuring quality and reliability."
                    </p>
                </div>
                <div className="grid grid-cols-4 sm:grid-cols-1 md:grid-cols-2 items-center gap-5">
                    <div className="card-container bg-[#FBFBFB] shadow-[0px_2px_10px_0_rgba(99,99,99,0.2)] rounded-lg rounded-b-none py-4 relative sm:mt-8 md:mt-5">
                        ...
                        <h5 className="text-center pt-6 pb-3">
                    ...
                    <div className="card-container bg-[#FBFBFB] shadow-[0px_2px_10px_0_rgba(99,99,99,0.2)] rounded-lg p-4 relative sm:mt-8 md:mt-5">
                        <div className="rounded-full border-[1.35px] border-dotted border-[#FF204E] p-[5px] w-[60px] h-[60px] absolute left-[40%] top-[-22%] ">
                            <div className="bg-[#FF204E] flex justify-center items-center rounded-full">
                                <Image
                                    className=" rounded-full p-[11px] filter invert brightness-0 hue-rotate-180"
                        ...
                        <p className="text-[10px] text-center leading-[15px]">
                            Our service are designed to save you time and reduce
                            hiring costs by taking care of the entire
                            recruitment process.
                        </p>
                        <div className="absolute bottom-0 left-0 right-0 h-[5.5px] bg-[#FF204E] rounded-b-lg"></div>
                    </div>
                    <div className="card-container bg-[#FBFBFB] shadow-[0px_2px_10px_0_rgba(99,99,99,0.2)] rounded-lg py-4 relative sm:mt-8 md:mt-5">
                        <div className="rounded-full border-[1.35px] border-dotted border-[#FF204E] p-[5px] w-[60px] h-[60px] absolute left-[40%] top-[-22%] ">
                            <div className="bg-[#FF204E] flex justify-center items-center rounded-full">
                                <Image
                                    className=" rounded-full p-[11px] filter invert brightness-0 hue-rotate-180"
                    ...
                    <div className="card-container bg-[#FBFBFB] shadow-[0px_2px_10px_0_rgba(99,99,99,0.2)] rounded-lg py-4 relative sm:mt-8 md:mt-5">
                        ...
                        <p className="text-[10px] text-center leading-[15px] px-4">
                            We customize our recruitment process to match the
                            specific requirements of your projects, ensuring a
